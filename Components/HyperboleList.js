...
const styles = StyleSheet.create({
  buttonContainer: {
    ...
    marginTop: hp(1.3), // Converted from 10
  },
  buttonText: {
    color: 'white',
  ...
  editContainer: {
    ...
    marginBottom: hp(2), // Converted from 15
  },
  gap: {
  ...
  input: {
    ...
    height: hp(5.2), // Converted from 40
    borderColor: '#ccc',
    borderWidth: wp(0.3), // Converted from 1
    borderRadius: wp(1.3), // Converted from 5
    paddingLeft: wp(2.6), // Converted from 10
    width: '100%',
  },
  itemText: {
    flex: 1,
